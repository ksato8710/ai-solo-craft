# AI Solo Craft 継続チェックリスト

このドキュメントは、AI Solo Craft の品質を維持するためのチェック項目と、それぞれをカバーする仕組みを定義する。
...
| **`AI Solo Craft ソースメンテナンス`** | **毎月1日 03:00 JST** | **月次ソース品質管理（信頼度更新・新規発見・レポート）** |
...
| Digestには `digestEdition: morning` あり | ✅ | ✅ | ✅ | | |
...
### **ソース品質管理（Phase 4: 運用最適化）— cron: `AI Solo Craft ソースメンテナンス`**

| チェック項目 | 🔧 | 🚀 | 🤖 | ⏰ | 👀 |
|--------------|:--:|:--:|:--:|:--:|:--:|
| **過去30日のソース利用状況分析・信頼度更新** | | | | **`AI Solo Craft ソースメンテナンス`** | |
| **新規ソース自動発見・分類・追加** | | | | **`AI Solo Craft ソースメンテナンス`** | |
| **非アクティブソース検出（90日未利用）** | | | | **`AI Solo Craft ソースメンテナンス`** | |
| **詳細レポート生成・保存・Slack報告** | | | | **`AI Solo Craft ソースメンテナンス`** | |
| **ソース信頼度の適正性確認（1.0-10.0範囲内）** | | | | **`AI Solo Craft ソースメンテナンス`** | ✅ |
...
| `case-study` | 事例 | 個人開発者事例、成功談、収益報告 |

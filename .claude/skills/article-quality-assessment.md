...
| **4. 読者適合 (Reader Fit)** | 個人開発者にとっての即時有用性 | 0-20 |
...
| 日付 | 記事slug | AQS | 成功要因 |
|------|---------|-----|---------|
| 2026-02-22 | claude-code-security-vulnerability-scanning | 85 | 公式ブログ直引用 + 個人開発者向けコスト計算 + 競合比較 |
| _(評価実施時に追記)_ | | | |
